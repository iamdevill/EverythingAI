...
CREATE TABLE products (
    ...
    zoho_item_id VARCHAR(100), -- Zoho Books item ID
...
CREATE TABLE product_variants (
    ...
    weight DECIMAL(8,2),
    barcode VARCHAR(100),
    zoho_variant_id VARCHAR(100), -- Zoho Books variant ID
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE user_profiles (
    ...
    emailPerfect! I can see the types are well-defined. Now I need to create the complete database schema for Supabase. Let me create a SQL file with the complete schema:

<write_to_file>
<path>database/schema.sql</path>
<content>
-- EverythingAI E-commerce Database Schema
